...
## Two postdoc positions available. See calls below.

--------------------------------------

Postdoc/PhD candidates should have a PhD/MSc in Physics, Mathematics, or Computer Science with a thesis in one the following areas: quantum information and computation, mathematical programming, combinatorial optimization, or coding theory. Postdoc candidates should have a significant research record in the field. We appreciate proactive researchers with a good ability for cooperation, a methodological way of working, and proficiency in English. Programming experience (Python/Julia, Sage, GAP, semidefinite programming) is a plus.
