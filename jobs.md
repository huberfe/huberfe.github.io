...
## PhD (4 years).  [Postdoc call below]
...
Candidates should have a MSc in Physics, Mathematics, or Computer Science. The ideal candidate took courses or did projects in quantum information and computation, mathematical programming, combinatorial optimization, or coding theory. We appreciate a proactive personality with a good ability for cooperation, a methodological way of working, and proficiency in English. Programming experience (Python/Julia, Sage, GAP, semidefinite programming) is a plus.
